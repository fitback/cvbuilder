...
| 版本 | 日期 | 变更说明 |
|------|------|----------|
| v1.0 MVP | 2026-05-07 | 初稿：架构设计、数据库、API、页面规划 |
| v0.3.0 | 2026-05-23 | 首页改版、登录流程优化、管理员支付二维码 |
| v0.4.0 | 2026-05-28 | 部署迁移方案：[DEPLOY-MIGRATION-v0.4.0.md](docs/DEPLOY-MIGRATION-v0.4.0.md) |
...
本地 Docker Compose 运行 PostgreSQL + Redis，前后端手动启动。

### 11.2 生产环境（v0.4.0 规划）

详见 [docs/DEPLOY-MIGRATION-v0.4.0.md](docs/DEPLOY-MIGRATION-v0.4.0.md)

| 方案 | 适用场景 | 月费 |
|------|----------|------|
| **方案 A（推荐）：阿里云单机** | 面向国内用户，零代码改造 | ¥75-110 |
| 方案 B：多云免费 | 海外用户，零成本起步 | $0 |

采用 Docker Compose 一键部署，与本地开发环境完全一致。
